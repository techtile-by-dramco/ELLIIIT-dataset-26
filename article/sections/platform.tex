...
\begin{figure*}[t]
    ...
    \end{subfigure}
    \caption{Visual overview of the ARFT measurement setup, from room-scale deployment to the co-located RF-acoustic payload on the rover.}
...
\begin{figure}[t]
    ...
    \caption{Trajectory and sampled measurement locations.}\label{fig:samples}
\end{figure}
