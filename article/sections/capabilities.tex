...
\includegraphics[width=0.9\textwidth]{article/figures/correlation_graph_good_example.png}
    \caption{Ranging estimate example for cycle 304 EXP007 microphone C04 with the correlation values and LPF values. The correct peak resulting in the estimated range is determined using the peak-prominence algorithm. The estimated and ground-truth range is depicted. \vspace{-3mm}}
...
\begin{figure}[t]
    ...
    \caption{Example per-position \gls{rf} power snapshot over the 42 ceiling receivers. \vspace{-3mm}}\label{fig:capability-artifacts}
\end{figure}
