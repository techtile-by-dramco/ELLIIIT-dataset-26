...
def build_mount_option_candidates(experiment_config=None):
    ...
    guest_variants = [
        ...
        [f"vers={smb_version}", "username=guest", "password="],
        [f"vers={smb_version}", "username=guest", "password=", "sec=none"],
        [f"vers={smb_version}", "username=anonymous", "password="],
        [f"vers={smb_version}", "username=anonymous", "password=", "sec=none"],
        ["guest"],
        ["guest", "sec=none"],
        ["username=guest", "password="],
        ["username=guest", "password=", "sec=none"],
        ["username=anonymous", "password="],
        ["username=anonymous", "password=", "sec=none"],
        ["vers=2.1", "guest"],
        ["vers=2.1", "guest", "sec=none"],
        ["vers=2.1", "username=guest", "password="],
        ["vers=2.1", "username=guest", "password=", "sec=none"],
        ["vers=2.0", "guest"],
        ["vers=2.0", "guest", "sec=none"],
        ["vers=2.0", "username=guest", "password="],
        ["vers=2.0", "username=guest", "password=", "sec=none"],
        ["vers=1.0", "guest"],
