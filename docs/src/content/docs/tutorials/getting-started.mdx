...
Before using the measurements in a model, read [Assumptions and Limitations](../../reference/assumptions-and-limitations/) for validity filtering, phase and amplitude conventions, antenna offsets, and propagation assumptions.
